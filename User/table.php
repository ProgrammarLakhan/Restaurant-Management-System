...
<body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div class="sidebar" style="background-image: url(../dist/img/blur-restaurant-3.png)">
                ...
                <div class="form-inline">
                    <div class="input-group" data-widget="sidebar-search">
                        <input class="form-control form-control-sidebar" id="myInput" type="text" placeholder="Search"
    ...
    <script>
        ...
        function PrintInvoice() {
            ...
            InvoiceData.shift(); // first row is the table header - so remove
                                        ...
                                        "<body style='height:290px;width:400px'>"+
                                            ...
                                            "<img src='../images/bill-head-bw.png' alt='Logo' style='height:120px;width:400px'>"+
                                                ...
                                                "<div style='width: 164px;'>"+
                                                    "<img src='thankyou.png' style='width:50%;padding: 10px;' alt=''>"+
                                                        "</div>"+
